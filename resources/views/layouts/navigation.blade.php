<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @auth
                        @if (Auth::user()->is_admin)
                            ...
                            <x-nav-link :href="route('admin.wallpapers.index')" :active="request()->routeIs('admin.wallpapers.*')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                @if (Auth::user()->is_admin)
                    ...
                    <x-responsive-nav-link :href="route('admin.wallpapers.index')" :active="request()->routeIs('admin.wallpapers.*')">
                        {{ __('Manage Wallpapers') }}
                    </x-responsive-nav-link>
                @endif
            @endauth
        ...
        @else
            <!-- Responsive Login and Register links for mobile -->
            <div class="pt-4 pb-1 border-t border-gray-200">
                <div class="mt-3 space-y-1">
